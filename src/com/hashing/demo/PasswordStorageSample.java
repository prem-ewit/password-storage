...
public class PasswordStorageSample {
  ...
  public static void main(String[] args) throws Exception {
   ...
   // String hashPassword = createHash(wrongPassword.toCharArray());
    ...
    if (isCorrectPassword) {
      System.out.println("Input password matches with the hashed password : " + isCorrectPassword);
    } else {
      System.out.println("Input password matches with the hashed password : " + isCorrectPassword);
    }
  }
  ...
  //Method to create Hash for the provided input
  ...
  private static boolean verifyPassword(char[] password, String correctHash)
    ...
    if (!params[HASH_ALGORITHM_INDEX].equals(HASHING_ALGO)) {
  ...
  private static boolean showEquals(byte[] a, byte[] b) {
